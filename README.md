...
- [dash-template](#dash-template)
    ...
    - [How to](#how-to)
        ...
        - [Add a matplotlib plot](#add-a-matplotlib-plot)
            - [Option 1: Take a screenshot / save the plot as an image](#option-1-take-a-screenshot--save-the-plot-as-an-image)
            - [Option 2: Convert matplotlib figures to Plotly figures](#option-2-convert-matplotlib-figures-to-plotly-figures)
